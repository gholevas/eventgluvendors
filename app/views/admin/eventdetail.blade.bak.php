                                        ...
                                        <table class="table table-condensed">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    {
                                                        $food_option_adults = Menu::find($event->food_option);
                                                        $food_option_kids = Menu::find($event->food_option_kids);

                                                        ?>
                                                        <td><b>Food</b><br>{{{$food_option_adults->name}}}<br>{{{$food_option_kids->name}}} (for kids)<br></td>
                                                        <td class="text-center"></td>
                                                        <td class="text-center"><br>{{{$event->guests_adults}}}<br>{{{$event->guests_kids}}}</td>
                                                        <td class="text-right"></td>
                                                        <?php
                                                    }
                                                     else if (isset($event->food_option))
                                                    {
                                                        $food_option = Menu::find($event->food_option);
                                                        ?>
                                                        <td><b>Food</b><br>{{{$food_option->name}}}</td>
                                                        <td class="text-center"></td>
                                                        <td class="text-center"><br>{{{$event->guests_adults + $event->guests_kids}}}</td>
                                                        <td class="text-right"></td>
                                                        <?php
                                                    }
                                                     else
                                                ...
                                                <tr>
                                                    ...
                                                    {
                                                        $drink_option_adults = Menu::find($event->drink_option);
                                                        $drink_option_kids = Menu::find($event->drink_option_kids);

                                                        ?>
                                                        <td><b>Drink</b><br>{{{$drink_option_adults->name}}}<br>{{{$drink_option_kids->name}}} (for kids)<br></td>
                                                        <td class="text-center"></td>
                                                        <td class="text-center"><br>{{{$event->guests_adults}}}<br>{{{$event->guests_kids}}}</td>
                                                        <td class="text-right"></td>
                                                        <?php
                                                    }
                                                     else if (isset($event->drink_option))
                                                    {
                                                        $drink_option = Menu::find($event->drink_option);
                                                        ?>
                                                        <td><b>Drink</b><br>{{{$drink_option->name}}}</td>
                                                        <td class="text-center"></td>
                                                        <td class="text-center"><br>{{{$event->guests_adults + $event->guests_kids}}}</td>
                                                        <td class="text-right"></td>
                                                        <?php
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-offset-3">
												<select id="es-food" class="form-control select2">
											...
											<div class="col-md-offset-3">
												<div class="span4">
													<div @if ($event->food_option_kids == NULL) style='display: none;' @endif id='es-foodkids-display'>
														<select id="es-foodkids" class="form-control select2">
														<option value="">Select a package</option>
                                                        @foreach ($food_options as $option))
													...
													<a onclick="$('#es-foodkids-display').toggle(); /*$('#s2id_es-foodkids').toggle();*/ $('#es-foodkids').val(''); $(this).text(this.text=='Different package for kids?'?'Same package as adults':'Different package for kids?'); return false;" href="#">@if ($event->food_option_kids == NULL)Different package for kids?@else Same package as adults?@endif</a>
												</div>
											</div>
                                        </div>
                                         <!--select2 starts-->
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-offset-3">
												<select id="es-drink" class="form-control select2">
													<option value="">Select a package</option>
											...
											<div class="col-md-offset-3">
												<div class="span5">
													<div @if ($event->drink_option_kids == NULL) style='display: none' @endif id='es-drinkkids-display'>
														<select id="es-drinkkids" class="form-control select2">
															<option value="">Select a package</option>
                                                            @foreach ($drink_options as $option))
													...
													<a onclick="$('#es-drinkkids-display').toggle(); /*$('#s2id_es-drinkkids').toggle();*/ $('#es-drinkkids').val(''); $(this).text(this.text=='Different package for kids?'?'Same package as adults':'Different package for kids?');return false;" href="#">@if ($event->drink_option_kids == NULL)Different package for kids?@else Same package as adults?@endif</a>
                                        		</div>
											</div>
                                        </div>
										<div class="form-group">
