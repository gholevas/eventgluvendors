...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li>
            <a href="#"> <i class="livicon" data-name="home" data-size="14" data-loop="true"></i>
                Home
            </a>
        </li>
        <li>
...
<section class="content paddingleft_right15">
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <h3 class="panel-title"> <i class="livicon" data-name="brightness-down" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i>
                Animated Icons
            </h3>
