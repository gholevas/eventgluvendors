...
<link rel="stylesheet" href="{{ asset('assets/vendors/gallery/2d/normalize.css') }}" media="screen" />
<!--page level css end-->
@stop
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#fancybox-manual-a").click(function() {
            $.fancybox.open('public/assets/vendors/gallery/basic/img/1_b.jpg');
        });
        ...
        $("#fancybox-manual-c").click(function() {
            $.fancybox.open([{
                href: 'public/assets/vendors/gallery/basic/img/1_b.jpg',
                title: 'My title'
            }, {
                href: 'public/assets/vendors/gallery/basic/img/2_b.jpg',
                title: '2nd title'
            }, {
                href: 'public/assets/vendors/gallery/basic/img/3_b.jpg'
            }], {
                helpers: {
                    thumbs: {
                        width: 75,
