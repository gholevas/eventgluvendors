...
<script src="{{ asset('assets/vendors/ion.rangeSlider/js/ion-rangeSlider/ion.rangeSlider.js') }}"></script>
<script src="{{ asset('assets/vendors/slider/bootstrap-slider.js') }}"></script>
<script>
$(function($) {
