    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="featured-post-wide">
                <img data-src="holder.js/791x263/#418bca:#fff" class="img-responsive" alt="Image">
                <div class="featured-text relative-left">
                    <h3>
                        <a href="#">Sample blog post</a>
                    </h3>
                    ...
                    <hr>
                    <p class="text-right">
                        <a href="blog_details" class="btn btn-info">Read more</a>
                    </p>
                </div>
                <!-- /.featured-text --> </div>
            <!-- /.featured-post-wide -->
            ...
            <!-- BEGIN FEATURED POST -->
            <div class="featured-post-wide">
                <img data-src="holder.js/791x263/#6cc66c:#fff" class="img-responsive" alt="Image">
                <div class="featured-text relative-left">
                    <h3>
                        <a href="#">Sample blog post 2</a>
                    </h3>
                    <p class="date">2 hours ago</p>
                    <p>
                        Science cuts two ways, of course; its products can be used for both good and evil. But there's no turning back from science. The early warnings about technological dangers also come from science.
            ...
            <!-- BEGIN FEATURED POST -->
            <div class="featured-post-wide">
                <img data-src="holder.js/791x263/#67C5DF:#fff" class="img-responsive" alt="Image">
                <div class="featured-text relative-left">
                    <h3>
                        <a href="#">Sample blog post 3</a>
                    </h3>
                    <p class="date">2 hours ago</p>
                    <p>
                        Science cuts two ways, of course; its products can be used for both good and evil. But there's no turning back from science. The early warnings about technological dangers also come from science.
        ...
        <div class="col-md-4">
            ...
            <div class="the-box no-border bg-danger text-center signup-newsletter">
                ...
                <hr>
                <p>
                    <button class="btn btn-danger btn-block">READ MORE THIS STORY</button>
                </p>
            </div>
            <!-- /.the-box .no-border -->
            <!-- END POPULAR POST -->
            ...
            <div class="the-box no-border">
                ...
                <ul class="media-list media-xs media-dotted">
                    <li class="media">
                        <div class="media-body">
                            <h4 class="media-heading">
                                <a href="#">Duis autem vel eum iriure dolor in hendrerit in</a>
                            </h4>
                            <p class="date">
                    ...
                    <li class="media">
                        <div class="media-body">
                            <h4 class="media-heading">
                                <a href="#">Nam liber tempor cum soluta nobis eleifend</a>
                            </h4>
                            <p class="date">
