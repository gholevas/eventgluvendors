    ...
    <div class="row">
        <div class="col-sm-8 col-md-9 col-full-width-right">
            <div class="blog-detail-image">
                <img data-src="holder.js/791x380/#6cc66c:#fff" class="img-responsive" alt="Image"></div>
            <!-- /.blog-detail-image -->
        ...
        <div class="col-sm-4 col-md-3 col-full-width-left">
            ...
            <div class="the-box no-border no-margin more-padding">
                ...
                <ul class="media-list media-sm media-dotted recent-post">
                    <li class="media">
                        <div class="media-body">
                            <h4 class="media-heading">
                                <a href="blog-detail">Duis autem vel eum iriure dolor in hendrerit in</a>
                            </h4>
                            <p>
                    ...
                    <li class="media">
                        <div class="media-body">
                            <h4 class="media-heading">
                                <a href="blog-detail">Nam liber tempor cum soluta nobis eleifend</a>
                            </h4>
                            <p>
                                Cras purus odio, vestibulum in vulputate at, tempus viverra turpis.
                            </p>
                    ...
                    <li class="media">
                        <div class="media-body">
                            <h4 class="media-heading">
                                <a href="blog-detail">Typi non habent claritatem insitam</a>
                            </h4>
                            <p>
                                Cras purus odio, vestibulum in vulputate at, tempus viverra turpis.
                            </p>
                    ...
                    <li class="media">
                        <div class="media-body">
                            <h4 class="media-heading">
                                <a href="blog-detail">Claritas est etiam processus dynamicus</a>
                            </h4>
                            <p>
                                Cras purus odio, vestibulum in vulputate at, tempus viverra turpis.
                            </p>
            ...
            <!-- /.the-box .bg-primary .no-border .text-center .no-margin --> </div>
        <!-- /.col-sm-3 --> </div>
    <!--main content ends-->
</section>
@stop