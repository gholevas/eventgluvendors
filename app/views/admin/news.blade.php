        ...
        <div class="col-md-12 news-page">
            ...
            <div class="row">
                <div class="col-md-5">
                    <div id="myCarousel" class="carousel image-carousel slide">
                        <div class="carousel-inner">
                            <div class="active item">
                                <img data-src="holder.js/2000x278/#6cc66c:#fff" class="img-responsive" alt=""></div>
                            <div class="item">
                                <img data-src="holder.js/2000x278/#67c5df:#fff" class="img-responsive" alt=""></div>
                            <div class="item">
                    ...
                    <div class="top-news margin-top-10">
                        <a href="#" class="btn-red">
                            <span>Featured News</span> <em><i class="fa fa-tags"></i>
                    ...
                    <div class="news-blocks">
                        <h3>
                            <a href="news_item">Older Stories go lower</a>
                        </h3>
                        <div class="news-block-tags"> <strong>CA, USA</strong> <em>3 hours ago</em>
                        </div>
                        <p>
                    ...
                    <div class="news-blocks">
                        ...
                        <div class="news-block-tags"> <strong>China</strong>
                            <em>7 hours ago</em>
                        </div>
                        <p>
                    ...
                    <div class="news-blocks">
                        <h3>
                            <a href="news_item">U.S. surges past Canada at World Lacrosse games</a>
                        </h3>
                ...
                <div class="col-md-3">
                    <div class="news-blocks">
                        <h3>
                            <a href="news_item">Futures Game: Gallo gives US 3-2 win over World</a>
                        </h3>
                        <div class="news-block-tags">
                            <strong>US</strong>
                        </div>
                    ...
                    <div class="news-blocks">
                        <h3>
                            <a href="news_item">World Cup 2014: 11 things the tournament taught us</a>
                        </h3>
                        <div class="news-block-tags">
                            <strong>US</strong>
                            <em>3 hours ago</em>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="news-blocks">
                        <h3>
                            <a href="news_item">Egypt proposes Israel-Gaza ceasefire</a>
                        </h3>
                        <div class="news-block-tags">
                            <strong>Egypt</strong>
                            <em>2 hours ago</em>
                    ...
                    <div class="news-blocks">
                        <h3>
                            <a href="news_item">Hague quits as foreign secretary</a>
                        </h3>
                        <div class="news-block-tags">
                            <strong>UK</strong>
                            <em>6 hours ago</em>
                ...
                <div class="col-md-3">
                    <div class="news-blocks">
                        <h3>
                            <a href="news_item">Murder victim's family want answers</a>
                        </h3>
                        <div class="news-block-tags">
                    ...
                    <div class="news-blocks">
                        <h3>
                            <a href="news_item">Brooks Irish shows will not go ahead</a>
                        </h3>
                        <div class="news-block-tags">
                ...
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="news-blocks">
                                <h3>
                                    <a href="news_item">Dying patients 'bewildered by array of services'</a>
                                </h3>
                                <div class="news-block-tags">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="news-blocks">
                                <h3>
                                    <a href="news_item">All aboard: China's railway dream</a>
                                </h3>
                                <div class="news-block-tags">
                                    <strong>China</strong>
                                    <em>3 hours ago</em>
                        ...
                        <div class="col-md-6">
                            <div class="news-blocks">
                                <h3>
                                    <a href="news_item">Record number of data complaints made to ICO</a>
                                </h3>
                                <div class="news-block-tags">
